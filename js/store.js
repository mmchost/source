...
function AddProducts(list)
{
	...
	if (cell)
	{
		...
		for (var i=0; i<list.length; i++)
		{
			...
			var buttonText = Number(list[i]["price"]) > 0 ? "Adaugă în coș" : "Solicită oferta";
			...
			var link = "product/" + list[i]["page"]; // + param;
			...
			var priceCell = Number(list[i]["price"]) > 0 ? "<tr><td align='center' class='item-price-cell'>" + list[i]["price"] + " Lei<a style='font-size:12px; color:#484848; font-weight:300;'>&nbsp;&nbsp;*TVA inclus</a></td></tr>" : "<tr><td align='center' class='item-price-cell'></td></tr>";
			cellValue +=
